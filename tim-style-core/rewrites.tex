...
\begin{figure}[t]
  ...
  \begin{array}{lr@{\;}c@{\;}l@{}}
      ...
      \text{Programs} & p  & ::=  & \ensuremath{\textbf{one}(\Varid{r})\{\Varid{b}\}} \quad \text{where} \; \freevars{b} = \{ r \} \\
      \text{Bodies} & b & ::= & \ensuremath{\Varid{v}\hspace{-0.14em}=\hspace{-0.14em}\Varid{e}} \vb \ensuremath{\Varid{b}_{\mathrm{1}};\,\Varid{b}_{\mathrm{2}}} \vb \ensuremath{\exists\Varid{x}.\,\Varid{b}} \vb \ensuremath{\Varid{b}_{\mathrm{1}}\;\rule[-0.1em]{0.15em}{0.75em}\;\Varid{b}_{\mathrm{2}}} \vb \ensuremath{\textbf{fail}} \vb \ensuremath{\textbf{succeed}} \\
      \text{Expressions}   & e     & ::= & \ensuremath{\Varid{v}} \vb \ensuremath{\Varid{v}_{\mathrm{1}}\,\Varid{v}_{\mathrm{2}}} \vb \ensuremath{\textbf{one}(\Varid{r})\{\Varid{b}\}} \vb \ensuremath{\textbf{all}(\Varid{r})\{\Varid{b}\}} \\
      \text{Values} & \ensuremath{\Varid{v}} & ::= & x  \vb \hnf \\
      \text{Head values} & \hnf & ::= & k \vb op \vb \ensuremath{\langle\Varid{v}_{\mathrm{1}},\mydots,\Varid{v}_{\Varid{n}}\rangle} \vb \ensuremath{\lambda\Varid{x}\!\shortrightarrow{}\!\Varid{r}.\,\Varid{b}} \\
...
\begin{figure}
    $$
      \begin{array}{lr@{\;}c@{\;}l}
      \text{Substitution contexts} & S & ::= & \hole \vb \ensuremath{\Varid{b};\,\Conid{S}} \vb \vb \ensuremath{\Conid{S};\,\Varid{b}} \\
...
\rulename{app-gt-fail}      & \ensuremath{\Varid{v}\mathrel{=}\textbf{gt}\langle\Varid{k}_{\mathrm{1}},\Varid{k}_{\mathrm{2}}\rangle}   & \movesto & \ensuremath{\textbf{fail}} &  \text{if $k_1 \leq k_2$} \\
\rulename{app-beta}^{\alpha} & \ensuremath{\Varid{v}_{\mathrm{1}}\mathrel{=}(\lambda\Varid{x}\!\shortrightarrow{}\!\Varid{r}.\,\Varid{b})(\Varid{v}_{\mathrm{2}})} & \movesto & \ensuremath{\exists\Varid{x}.\,\Varid{x}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v}_{\mathrm{2}};\,\exists\Varid{r}.\,\Varid{b};\,\Varid{v}_{\mathrm{1}}\hspace{-0.14em}=\hspace{-0.14em}\Varid{r}}
                                                  & \text{if $x,r \not\in \freevars{\ensuremath{\Varid{v}_{\mathrm{1}},\Varid{v}_{\mathrm{2}}}}$} \\
...
\rulegroupname{Unification:}
  \rulename{u-lit}   & \ensuremath{\Varid{k}_{\mathrm{1}}\hspace{-0.14em}=\hspace{-0.14em}\Varid{k}_{\mathrm{2}}} & \movesto & \ensuremath{\textbf{succeed}} & \text{if $k_1=k_2$} \\
%%  \rulename{u-tup} & \hspace{-1.8em} |tup (v_1,xdots,v_n) == tup (v1',xdots,v_n'); e| & \movesto & |v_1==v1';xdots;v_n==v_n'; e| \\
  \rulename{u-tup} & \hspace{-2.0em} \ensuremath{\langle{}\Varid{v}_{\mathrm{0}},\mydots,\Varid{v}_{\Varid{n}}\rangle\hspace{-0.14em}=\hspace{-0.14em}\langle{}\Varid{v}_{0}',\mydots,\Varid{v}_{\Varid{n}}'\rangle} & \movesto & \ensuremath{\Varid{v}_{\mathrm{0}}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v}_{0}';\,\mydots;\,\Varid{v}_{\Varid{n}}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v}_{\Varid{n}}'} \\
  \rulename{u-tup-0} & \hspace{-2.0em} \ensuremath{\langle\rangle\hspace{-0.14em}=\hspace{-0.14em}\langle\rangle} & \movesto & \ensuremath{\textbf{succeed}} \\
  \rulename{u-fail} & \ensuremath{\mathit{hnf}_{\!1}\hspace{-0.14em}=\hspace{-0.14em}\mathit{hnf}_{\!2}} & \movesto & \ensuremath{\textbf{fail}} & \text{if \rulename{u-lit}, \rulename{u-tup}, \rulename{u-tup-0} do not match} \\
  ...
  \rulename{subst} & \ensuremath{\Conid{S} [\mskip1.5mu \Varid{x}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v}\mskip1.5mu]} & \movesto & \ensuremath{(\subst{\Conid{S}}{\Varid{x}}{\Varid{v}}) [\mskip1.5mu \Varid{x}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v}\mskip1.5mu]} \hspace*{-0.3em}
  & \text{if $\ensuremath{\Varid{x}} \in \freevars{\ensuremath{\Conid{S}}}$, $\ensuremath{\Varid{x}} \notin \freevars{\ensuremath{\Varid{v}}}$ or $\ensuremath{\Varid{v}}$ is a lambda}, \\
  &&&& \text{\hskip 0.7em and ($(\ensuremath{\Varid{v}} = \ensuremath{\Varid{y}} \implies \ensuremath{\Varid{x}} \prec \ensuremath{\Varid{y}})$)} \\
  \rulename{hnf-swap} & \ensuremath{\mathit{hnf}\hspace{-0.14em}=\hspace{-0.14em}\Varid{x}}    & \movesto & \ensuremath{\Varid{x}\hspace{-0.14em}=\hspace{-0.14em}\mathit{hnf}} \\
  \rulename{var-swap} & \ensuremath{\Varid{y}\hspace{-0.14em}=\hspace{-0.14em}\Varid{x}}    & \movesto & \ensuremath{\Varid{x}\hspace{-0.14em}=\hspace{-0.14em}\Varid{y}} & \text{if \ensuremath{\Varid{x}} $\prec$ \ensuremath{\Varid{y}} } \\
...
%%  \rulename{val-swap-ord} & |eq_1; eq_2; e| & \movesto & |eq_2; eq_1; e| & \text{if |eq_2| $\prec$ |eq_1| } \\
  \rulename{seq-swap} & \ensuremath{\Varid{b};\,\Varid{x}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v}} & \movesto & \ensuremath{\Varid{x}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v};\,\Varid{b}} &
                      \text{unless (\ensuremath{\Varid{b}} is \ensuremath{\Varid{y}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v'}} and \ensuremath{\Varid{y}} $\preceq$ \ensuremath{\Varid{x}})} \\

    \\[-0.6em]

\rulegroupname{Elimination:}
\rulename{succ-elim1} & \ensuremath{\textbf{succeed};\,\Varid{b}} & \movesto & \ensuremath{\Varid{b}} \\
\rulename{succ-elim2} & \ensuremath{\Varid{b};\,\textbf{succeed}} & \movesto & \ensuremath{\Varid{b}} \\
\rulename{exi-elim} & \ensuremath{\exists\Varid{x}.\,\Varid{b}} & \movesto & \ensuremath{\Varid{b}} & \text{if $\ensuremath{\Varid{x}} \notin \freevars{\ensuremath{\Varid{b}}}$}\\
\rulename{eqn-elim} & \ensuremath{\exists\Varid{x}.\,\Conid{S} [\mskip1.5mu \Varid{x}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v};\,\Varid{b}\mskip1.5mu]} & \movesto & \ensuremath{\Conid{S} [\mskip1.5mu \Varid{b}\mskip1.5mu]} & \text{if $\ensuremath{\Varid{x}} \notin \freevars{\ensuremath{\Conid{S} [\mskip1.5mu \Varid{v};\,\Varid{b}\mskip1.5mu]}}$} \\
\rulename{fail-elim} & \ensuremath{\Conid{S} [\mskip1.5mu \textbf{fail}\mskip1.5mu]} & \movesto & \ensuremath{\textbf{fail}} & \text{if $\ensuremath{\Conid{S}} \ne \hole$} \\

    \\[-0.6em]

\rulegroupname{Normalization:}
\rulename{exi-float}^{\alpha} & \ensuremath{\Conid{S} [\mskip1.5mu \exists\Varid{x}.\,\Varid{b}\mskip1.5mu]} & \movesto & \ensuremath{\exists\Varid{x}.\,\Conid{S} [\mskip1.5mu \Varid{b}\mskip1.5mu]} & \text{if $\ensuremath{\Conid{S}} \ne \hole,\,  x \notin \freevars{\ensuremath{\Conid{S}}}$} \\
\rulename{seq-assoc} & \ensuremath{(\Varid{b}_{\mathrm{1}};\,\Varid{b}_{\mathrm{2}});\,\Varid{b}_{\mathrm{3}}} & \movesto & \ensuremath{\Varid{b}_{\mathrm{1}};\,(\Varid{b}_{\mathrm{2}};\,\Varid{b}_{\mathrm{3}})} \\
\rulename{exi-swap} & \ensuremath{\exists\Varid{x}.\,\exists\Varid{y}.\,\Varid{b}} & \movesto & \ensuremath{\exists\Varid{y}.\,\exists\Varid{x}.\,\Varid{b}} \\
...
\rulename{one-fail}   & \ensuremath{\Varid{v}\hspace{-0.14em}=\hspace{-0.14em}\textbf{one}(\Varid{r})\{\textbf{fail}\}} & \movesto & \ensuremath{\textbf{fail}} \\
\rulename{one-value}  & \ensuremath{\textbf{one}(\Varid{r})\{\Varid{r}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v}\}} & \movesto & \ensuremath{\Varid{v}} \\
\rulename{one-choice}  & \ensuremath{\textbf{one}(\Varid{r})\{\Varid{r}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v}\hspace{0.2em}\mathop{\rule[-0.1em]{0.15em}{0.75em}}\hspace{0.2em}\Varid{b}\}} & \movesto & \ensuremath{\Varid{v}} \\
\rulename{all-fail}   & \ensuremath{\textbf{all}(\Varid{r})\{\textbf{fail}\}} & \movesto & \ensuremath{\langle{}\rangle} \\
\rulename{all-choice} & \ensuremath{\textbf{all}(\Varid{r})\{\Varid{r}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v}_{\mathrm{1}}\;\rule[-0.1em]{0.15em}{0.75em}\;\mydots\;\rule[-0.1em]{0.15em}{0.75em}\;\Varid{r}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v}_{\Varid{n}}\}} & \movesto & \ensuremath{\langle{}\Varid{v}_{\mathrm{1}},\mydots,\Varid{v}_{\Varid{n}}\rangle} \\
\rulename{choose-r} & \ensuremath{\textbf{fail}\;\rule[-0.1em]{0.15em}{0.75em}\;\Varid{b}} & \movesto & \ensuremath{\Varid{b}} \\
\rulename{choose-l} & \ensuremath{\Varid{b}\;\rule[-0.1em]{0.15em}{0.75em}\;\textbf{fail}} & \movesto & \ensuremath{\Varid{b}} \\
\rulename{choose-assoc} & \ensuremath{(\Varid{b}_{\mathrm{1}}\;\rule[-0.1em]{0.15em}{0.75em}\;\Varid{b}_{\mathrm{2}})\;\rule[-0.1em]{0.15em}{0.75em}\;\Varid{b}_{\mathrm{3}}} & \movesto & \ensuremath{\Varid{b}_{\mathrm{1}}\;\rule[-0.1em]{0.15em}{0.75em}\;(\Varid{b}_{\mathrm{2}}\;\rule[-0.1em]{0.15em}{0.75em}\;\Varid{b}_{\mathrm{3}})} \\
\rulename{choose} & \ensuremath{\Conid{SX} [\mskip1.5mu CX [\mskip1.5mu \Varid{b}_{\mathrm{1}}\;\rule[-0.1em]{0.15em}{0.75em}\;\Varid{b}_{\mathrm{2}}\mskip1.5mu]\mskip1.5mu]} & \movesto & \ensuremath{\Conid{SX} [\mskip1.5mu CX [\mskip1.5mu \Varid{b}_{\mathrm{1}}\mskip1.5mu]\;\rule[-0.1em]{0.15em}{0.75em}\;CX [\mskip1.5mu \Varid{b}_{\mathrm{2}}\mskip1.5mu]\mskip1.5mu]} & \text{if}~\ensuremath{CX} \ne \hole \\
