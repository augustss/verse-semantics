...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |x = v; e'|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |k1 = k2|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=scriptsize]
...
\end{tikzcd}\vskip6pt
\end{center}
The condition to be proved is {\color{purple}\text{$|k1|=|k2|$}} (for \rulename{u-lit}); {\color{red}please provide the necessary proof}.\par
This is a simple decreasing diagram.
\par
\vskip 8pt plus 16pt\noindent
...
assuming the condition {\color{blue}\text{$|k1|=|k2|$}} (for \rulename{u-lit}) is satisfied,\vadjust{\penalty1000}\hfil\break
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |k1 = k2|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=scriptsize]
  {|k1 = k2; fail|} && {|fail|} \\
  & {(11)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def x (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |k1 = k2|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=scriptsize]
...
assuming the condition {\color{blue}\text{$|k1|=|k2|$}} (for \rulename{u-lit}) is satisfied,\vadjust{\penalty1000}\hfil\break
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |k1 = k2|,\,|e1|\mapsto |e|\,\}$}:\par\leavevmode\null\hskip 2em minus 1.95em {\color{green}$|t_1| \equiv |(x = e; e2)| \xrnungosup{u-lit}{\1\2} |t| \xrngosup{eqn-float}{\emptypath} |(k1 = k2; (x = e; e2))| \equiv |t_2|$}\par
\noindent{\color{purple}Can they be joined?\vadjust{\penalty1000}\hfil\break}
\vadjust{\penalty1000}\hfil\break
\vadjust{\penalty1000}\hfil\break
\vadjust{\penalty1000}\hfil\break
...
assuming the condition {\color{blue}\text{$|k1|=|k2|$}} (for \rulename{u-lit}) is satisfied,\vadjust{\penalty1000}\hfil\break
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |k1 = k2|,\,|e1|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=scriptsize]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |x = v; e'|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |(tup (v1,xdots,vn)) = (tup (v1',xdots,vn'))|\,\}$}:\par\begin{center}
\begin{tikzcd}
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |(tup (v1,xdots,vn)) = (tup (v1',xdots,vn'))|\,\}$}:\par\begin{center}
\begin{tikzcd}
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def x (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |(tup (v1,xdots,vn)) = (tup (v1',xdots,vn'))|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=scriptsize]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |(tup (v1,xdots,vn)) = (tup (v1',xdots,vn'))|,\,|e1|\mapsto |e|\,\}$}:\par\leavevmode\null\hskip 2em minus 1.95em {\color{green}$|t_1| \equiv |(x = (v1 = v1'; xdots vn = vn'; e); e2)| \xrnungosup{u-tup}{\1\2} |t| \xrngosup{eqn-float}{\emptypath} |((tup (v1,xdots,vn)) = (tup (v1',xdots,vn')); (x = e; e2))| \equiv |t_2|$}\par
\noindent{\color{purple}Can they be joined?\vadjust{\penalty1000}\hfil\break}
\vadjust{\penalty1000}\hfil\break
\vadjust{\penalty1000}\hfil\break
\vadjust{\penalty1000}\hfil\break
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |(tup (v1,xdots,vn)) = (tup (v1',xdots,vn'))|,\,|e1|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=scriptsize]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|d|\mapsto |op'|\,\}$} and {\color{blue}$\sigma_2=\{\,|d'|\mapsto |op|,\,|e'|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
  {|op = op'; e|} && {|fail|} \\
  & {(20)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |x = v; e'|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |op = d|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
  {|op = d; (x = v; e')|} &&&& {|fail|} \\
  && {(21')} && \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |op = d|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|op = d; fail|} && {|fail|} \\
  & {(22)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def x (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |op = d|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
  {|op = d; (def x (e'))|} &&&& {|fail|} \\
  && {(23')} && \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |op = d|,\,|e1|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|(op = d; e); e2|} && {|op = d; (e; e2)|} \\
  & {(25)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |x = v; e'|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |d = op|\,\}$}:\par\begin{center}
\begin{tikzcd}
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |d = op|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
  {|d = op; fail|} && {|fail|} \\
  & {(27)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def x (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |d = op|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
  {|d = op; (def x (e'))|} &&&& {|fail|} \\
  && {(28')} && \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |d = op|,\,|e1|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
  {|(d = op; e); e2|} && {|d = op; (e; e2)|} \\
  & {(30)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |x = v; e'|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |(tup (v1,xdots,vn)) = k|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |(tup (v1,xdots,vn)) = k|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def x (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |(tup (v1,xdots,vn)) = k|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |(tup (v1,xdots,vn)) = k|,\,|e1|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |x = v; e'|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |k = (tup (v1,xdots,vn))|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |k = (tup (v1,xdots,vn))|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def x (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |k = (tup (v1,xdots,vn))|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |k = (tup (v1,xdots,vn))|,\,|e1|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |x' = v; e'|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |hnf = x|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |hnf = x|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|hnf = x; fail|} && {|fail|} \\
  & {(42)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def x' (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |hnf = x|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |hnf = x|,\,|e1|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |x' = v; e'|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |x = y|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|x = y; (x' = v; e')|} && {|x' = v; (x = y; e')|} \\
  & {(46)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|x'|\mapsto |x|,\,|v|\mapsto |y|,\,|e'|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|eq; (x = y; e)|} && {|x = y; (eq; e)|} \\
  & {(47)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |x = y|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|x = y; fail|} && {|fail|} \\
  & {(49)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def x' (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |x = y|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |x = y|,\,|e1|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|(x = y; e); e2|} && {|x = y; (e; e2)|} \\
  & {(52)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |x' = v'|\,\}$} and {\color{blue}$\sigma_2=\{\,|e'|\mapsto |x = v; e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |v'|\,\}$} and {\color{blue}$\sigma_2=\{\,|e'|\mapsto |x = v; e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|v'; (x = v; e)|} && {|x = v; e|} \\
  & {(54)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |v' = fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|e'|\mapsto |x = v; e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|v' = fail; (x = v; e)|} &&&& {|fail|} \\
  && {(56)} && \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|e'|\mapsto |x = v; e|\,\}$}:\par\begin{center}
\begin{tikzcd}
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |x = v|\,\}$} and {\color{blue}$\sigma_2=\{\,|e|\mapsto |fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
  {|eq'; (x = v; fail)|} &&&& {|eq'; fail|} \\
  && {(58')} && \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |v' = (def x' (e1))|\,\}$} and {\color{blue}$\sigma_2=\{\,|e2|\mapsto |x = v; e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=normal]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |def x' (e1)|\,\}$} and {\color{blue}$\sigma_2=\{\,|e2|\mapsto |x = v; e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |x' = v|\,\}$} and {\color{blue}$\sigma_2=\{\,|e'|\mapsto |def x (e)|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |x' = (eq'; e1)|\,\}$} and {\color{blue}$\sigma_2=\{\,|e2|\mapsto |x = v; e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |eq'; e1|\,\}$} and {\color{blue}$\sigma_2=\{\,|e2|\mapsto |x = v; e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq'|\mapsto |eq|,\,|e1|\mapsto |x = v; e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |v|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|v; fail|} && {|fail|} \\
  & {(66)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def x (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |v|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|v; (def x (e'))|} && {|def x ((v; e'))|} \\
  & {(67)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |v|,\,|e1|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
  {|(v; e); e2|} && {|v; (e; e2)|} \\
  & {(69)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def y (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|x'|\mapsto |x|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|y|\mapsto |x|,\,|e'|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|y|\mapsto |x|,\,|e'|\mapsto |x = v; e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |v = fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
  {|v = fail; fail|} && {|fail|} \\
  & {(82)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def x (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |v = fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
  {|v = fail; (def x (e'))|} &&&& {|fail|} \\
  && {(83')} && \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |v = fail|,\,|e1|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
  {|fail; fail|} && {|fail|} \\
  & {(86)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |def x (e')|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
  {|fail; (def x (e'))|} &&&& {|fail|} \\
  && {(87')} && \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |fail|,\,|e1|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
  {|(fail; e); e2|} && {|fail; (e; e2)|} \\
  & {(89)} & \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |v = (def x (e1))|\,\}$} and {\color{blue}$\sigma_2=\{\,|e2|\mapsto |fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |def x (e1)|\,\}$} and {\color{blue}$\sigma_2=\{\,|e2|\mapsto |fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
  {|(def x (e1)); fail|} &&&& {|fail|} \\
  && {(91')} && \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |x = (eq'; e1)|\,\}$} and {\color{blue}$\sigma_2=\{\,|e2|\mapsto |fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
  {|x = (eq'; e1); fail|} &&&& {|fail|} \\
  && {(92')} && \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |eq'; e1|\,\}$} and {\color{blue}$\sigma_2=\{\,|e2|\mapsto |fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
  {|(eq'; e1); fail|} &&&& {|fail|} \\
  && {(94')} && \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq'|\mapsto |eq|,\,|e1|\mapsto |fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
  {|(eq; fail); e2|} &&&& {|fail; e2|} \\
  && {(95')} && \\
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e2|\mapsto |def x' (e)|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |v = (def x (e1))|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
assuming the condition {\color{blue}\text{$|x|\not\in \freevars{|v|,|e2|}$}} (for \rulename{exi-float-eq}) is satisfied,\vadjust{\penalty1000}\hfil\break
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |v = (def x (e1))|,\,|e1'|\mapsto |e2|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e2|\mapsto |def x' (e)|\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |def x (e1)|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
assuming the condition {\color{blue}\text{$|x|\not\in \freevars{|e2|}$}} (for \rulename{exi-float-l}) is satisfied,\vadjust{\penalty1000}\hfil\break
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq|\mapsto |def x (e1)|,\,|e1'|\mapsto |e2|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |x' = (eq'; e1)|\,\}$} and {\color{blue}$\sigma_2=\{\,|e2|\mapsto |def x (e)|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|eq|\mapsto |eq'; e1|\,\}$} and {\color{blue}$\sigma_2=\{\,|e2|\mapsto |def x (e)|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
assuming the condition {\color{blue}\text{$|x|\not\in \freevars{|eq|}$}} (for \rulename{exi-float-r}) is satisfied,\vadjust{\penalty1000}\hfil\break
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq'|\mapsto |eq|,\,|e1|\mapsto |def x (e)|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq'|\mapsto |x = (eq; e1)|,\,|e1'|\mapsto |e2|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|eq'|\mapsto |eq; e1|,\,|e1'|\mapsto |e2|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|y'|\mapsto |x|,\,|e'|\mapsto |def y (e)|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |fail|\,\}$} and {\color{blue}$\sigma_2=\{\,|e'|\mapsto |fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|e1|\mapsto |fail|,\,|e2|\mapsto |e|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
...
using the substitutions {\color{blue}$\sigma_1=\{\,|e|\mapsto |e1 `choice` e2|\,\}$} and {\color{blue}$\sigma_2=\{\,|e3|\mapsto |fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|e1|\mapsto |e|,\,|e2|\mapsto |fail|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=normal]
...
using the substitutions {\color{blue}$\sigma_1=\{\,\}$} and {\color{blue}$\sigma_2=\{\,|e1'|\mapsto |e1 `choice` e2|,\,|e2'|\mapsto |e3|\,\}$}:\par\begin{center}
\begin{tikzcd}
  [row sep=large, column sep=large]
