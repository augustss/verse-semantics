...
\begin{array}{lr@{\;\;}c@{\;\;}l}
 \text{Expressions} & e & ::= & \ensuremath{\Varid{x}} \vb \ensuremath{\Varid{k}} \vb \ensuremath{\Varid{o}} \vb \ensuremath{\Varid{e}_{\mathrm{1}} [\!\Varid{e}_{\mathrm{2}}]} \vb \ensuremath{\Varid{e}_{\mathrm{1}};\,\Varid{e}_{\mathrm{2}}}
  ...
  && \vb &  \ensuremath{\langle\Varid{e}_{\mathrm{1}},..,\Varid{e}_{\Varid{n}}\rangle} \vb \ensuremath{\textbf{truth}\{\Varid{e}\}} \vb \ensuremath{\lambda\Varid{x} .\,\Varid{e}} \vb \ensuremath{\textbf{iter}(\Varid{ic})\{\Varid{e}\}\{\Varid{e}_{\mathrm{0}}\}}\\
  && \vb & \ensuremath{\textbf{choose}(\Varid{v})\{\Varid{e}\}} \vb \ensuremath{\textbf{arr}(\Varid{v})\{\Varid{e}\}} \\
  ...
  \text{Iter combinators} & ic & ::=
     & \ensuremath{\textbf{all}} \vb \ensuremath{\textbf{one}} \vb \ensuremath{\textbf{if}} \vb \ensuremath{\textbf{for}} \vb  \ensuremath{\textbf{count}}  \\
\end{array}
\\[1mm]
\hspace{3mm}\text{Note: ordinary \ensuremath{\lambda\Varid{x} .\,\Varid{e}}; no \ensuremath{\Varid{e}_{\mathrm{1}}\vartriangleright\Varid{e}_{\mathrm{2}}}; add \ensuremath{\textbf{verify}} and \ensuremath{{\bf some}}, \ensuremath{\textbf{choose}}, \ensuremath{\textbf{arr}} } \\[2mm]

\textbf{Iteration macros} \\
\begin{array}{rcl}
  \ensuremath{\textbf{if}[\Varid{v},\Varid{e}_{\mathrm{0}}]} & = & \ensuremath{\Varid{v}[]} \\
  \ensuremath{\textbf{one}[\Varid{v},\Varid{e}_{\mathrm{0}}]} & = & \ensuremath{\Varid{v}} \\
  \ensuremath{\textbf{count}[\Varid{v},\Varid{e}_{\mathrm{0}}]} & = & \ensuremath{\mathrm{1}\mathbin{+}\Varid{e}_{\mathrm{0}}} \\
  \ensuremath{\textbf{for}[\Varid{v},\Varid{e}_{\mathrm{0}}]} & = & \ensuremath{\exists\Varid{x}.\,\Varid{x}\hspace{-0.14em}=\hspace{-0.14em}\Varid{v}[];\,\textbf{all}[\Varid{x},\Varid{e}_{\mathrm{0}}]} \\
  \ensuremath{\textbf{all}[\Varid{v},\Varid{e}_{\mathrm{0}}]} & = & \ensuremath{\langle{}\Varid{v}\rangle+ \! + \,\Varid{e}_{\mathrm{0}}}
\end{array}

\end{array}
$$
\caption{Syntax of Core Verse} \label{fig:core-verse}
\end{figure}
...
% -------------- Basic rules ----------------
\begin{array}{lr@{\;\;}c@{\;\;}ll}
\rulename{vfail}  & \ensuremath{{\mathcal V}_{\sigma}\llbracket\textbf{fail}\rrbracket{}\pi}                  & = & \ensuremath{\textbf{fail}} \\
\rulename{vconst}  & \ensuremath{{\mathcal V}_{\sigma}\llbracket\Varid{k}\rrbracket{}\pi}                  & = & \ensuremath{\Varid{k}} \\
\rulename{vvar}    & \ensuremath{{\mathcal V}_{\sigma}\llbracket\Varid{x}\rrbracket{}\pi}                  & = & \ensuremath{\Varid{x}} \\
\rulename{vop}    & \ensuremath{{\mathcal V}_{\sigma}\llbracket\Varid{o}\rrbracket{}\pi}                  & = & \ensuremath{\Varid{o}} \\
\rulename{vapp}    & \ensuremath{{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{1}} [\!\Varid{e}_{\mathrm{2}}]\rrbracket{}\pi}
...
\rulename{vtup} & \ensuremath{{\mathcal V}_{\sigma}\llbracket\langle\Varid{e}_{\mathrm{1}},\mydots,\Varid{e}_{\Varid{n}}\rangle\rrbracket{}\pi}
...
\rulename{vtruth}    & \ensuremath{{\mathcal V}_{\sigma}\llbracket\textbf{truth}\{\Varid{e}\}\rrbracket{}\pi}                  & = & \ensuremath{\textbf{truth}\{{\mathcal V}_{\sigma}\llbracket\Varid{e}\rrbracket{}\pi\}} \\
\rulename{vbind}   & \ensuremath{{\mathcal V}_{\sigma}\llbracket\exists{}\;\Varid{x}\rrbracket{}\pi}          & = & \ensuremath{\exists{}\;\Varid{x}} \\
\rulename{veq}     & \ensuremath{{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{1}}\mathrel{=}\Varid{e}_{\mathrm{2}}\rrbracket{}\pi}          & = & \ensuremath{{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{1}}\rrbracket{}\pi\mathrel{=}{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{2}}\rrbracket{}\pi} \\
\rulename{vsemi}   & \ensuremath{{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{1}};\,\Varid{e}_{\mathrm{2}}\rrbracket{}\pi}        & = & \ensuremath{{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{1}}\rrbracket{}\pi;\,{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{2}}\rrbracket{}\pi} \\
\rulename{vchoice} & \ensuremath{{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{1}}\hspace{0.19em}\mathop{\rule[-0.1em]{0.15em}{0.75em}}\hspace{0.2em}\Varid{e}_{\mathrm{2}}\rrbracket{}\pi} & = & \ensuremath{{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{1}}\rrbracket{}\pi\hspace{0.19em}\mathop{\rule[-0.1em]{0.15em}{0.75em}}\hspace{0.2em}{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{2}}\rrbracket{}\pi} \\
\rulename{vfor}    & \ensuremath{{\mathcal V}_{\sigma}\llbracket\textbf{for}(\Varid{e}_{\mathrm{1}})\,\textbf{do}\,\Varid{e}_{\mathrm{2}}\rrbracket{}\pi}
   & = & \ensuremath{\textbf{iter}(\textbf{for})\{{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{1}}\rrbracket{}\pi;\,\lambda{\bullet} .\,{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{2}}\rrbracket{}\pi\}\{\langle\rangle\}} \\
\rulename{vall}    & \ensuremath{{\mathcal V}_{\sigma}\llbracket\textbf{all}\{\Varid{e}\}\rrbracket{}\pi} & = & \ensuremath{\textbf{iter}(\textbf{all})\{{\mathcal V}_{\sigma}\llbracket\Varid{e}\rrbracket{}\pi\}\{\langle\rangle\}} \\
\rulename{vone}    & \ensuremath{{\mathcal V}_{\sigma}\llbracket\textbf{one}\{\Varid{e}\}\rrbracket{}\pi} & = & \ensuremath{\textbf{iter}(\textbf{one})\{{\mathcal V}_{\sigma}\llbracket\Varid{e}\rrbracket{}\pi\}\{\textbf{fail}\}} \\
\multicolumn{2}{l}{\rulename{vif} \;\; \hfill \ensuremath{{\mathcal V}_{\sigma}\llbracket\;\textbf{if}\;\Varid{e}_{\mathrm{1}}\;\textbf{then}\;\Varid{e}_{\mathrm{2}}\;\textbf{else}\;\Varid{e}_{\mathrm{3}}\rrbracket{}\pi}}
& = & \multicolumn{2}{@{}l}{\ensuremath{\textbf{iter}(\textbf{if})\{{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{1}}\rrbracket{}\pi;\,\lambda{\bullet} .\,{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{2}}\rrbracket{}\pi\}\{{\mathcal V}_{\sigma}\llbracket\Varid{e}_{\mathrm{3}}\rrbracket{}\pi\}}}  \\
\rulename{vcheck+} & \ensuremath{{\mathcal V}_{+}\llbracket{\bf chk}\langle\omega\rangle\{\Varid{e}\}\rrbracket{}\pi} & = & \ensuremath{{\bf chk}\langle\omega\rangle\{{\mathcal V}_{+}\llbracket\Varid{e}\rrbracket{}\pi\}} \\
\rulename{vcheck-} & \ensuremath{{\mathcal V}_{-}\llbracket{\bf chk}\langle\omega\rangle\{\Varid{e}\}\rrbracket{}\pi} & = & \ensuremath{{\mathcal V}_{-}\llbracket\Varid{e}\rrbracket{}\pi} \\
\rulename{vcheckx} & \ensuremath{{\mathcal V}_{\textbf{x}}\llbracket{\bf chk}\langle\omega\rangle\{\Varid{e}\}\rrbracket{}\pi} & = & \ensuremath{{\bf chk}\langle\omega\rangle\{{\mathcal V}_{\textbf{x}}\llbracket\Varid{e}\rrbracket{}\pi\}} \\
\end{array}
\\
...
\rulename{voftype+} & \ensuremath{{\mathcal V}_{+}\llbracket\Varid{e}_{\mathrm{1}}\vartriangleright\hspace{-1.3mm} \langle\omega\rangle\,\Varid{e}_{\mathrm{2}}\rrbracket{}\pi}
& = & \begin{array}[t]{@{}l}
  \ensuremath{\textbf{verify}} (;) \left\{ \begin{array}{@{}l}
       ...
       \ensuremath{{\bf chk}\langle\textbf{succeeds}\rangle\{{\mathcal V}_{+}\llbracket\Varid{e}_{\mathrm{2}} [\!\Varid{r}]\rrbracket{}\pi\}}
  \end{array} \right\} ; \\
...
\rulename{voftypex} & \ensuremath{{\mathcal V}_{\textbf{x}}\llbracket\Varid{e}_{\mathrm{1}}\vartriangleright\hspace{-1.3mm} \langle\omega\rangle\,\Varid{e}_{\mathrm{2}}\rrbracket{}\pi}
& = & \begin{array}[t]{@{}l}
...
\begin{array}{lr@{\;\;}c@{\;\;}ll}
 ...
 \rulename{vfun+} &  \ensuremath{{\mathcal V}_{+}\llbracket\lambda_{\textbf{c}}\Varid{x}.(\Varid{e}_{\mathrm{1}})\{\Varid{e}_{\mathrm{2}}\}\rrbracket{}\pi}
...
\rulename{vfunx}& \ensuremath{{\mathcal V}_{\textbf{x}}\llbracket\lambda_{\textbf{c}}\Varid{x}.(\Varid{e}_{\mathrm{1}})\{\Varid{e}_{\mathrm{2}}\}\rrbracket{}\pi}
