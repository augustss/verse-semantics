...
-- TODO: actually use the variables
evalS :: SExp -> Env -> [Res]
evalS (Def _ e) rho = tieKnot $ eval e rho

evalVar :: Name -> Env -> Lenient
...
extendEnv :: Name -> Lenient -> Env -> Env
...
lookupEnv :: Name -> Env -> Maybe Lenient
lookupEnv = lookup
