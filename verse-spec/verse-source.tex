...
&      & \vb & \ensuremath{\Varid{t}_{\mathrm{1}}\;\mathbf{where}\;\Varid{t}_{\mathrm{2}}}             & \text{Reverse sequencing} \\
&      & \vb & \ensuremath{\Varid{t}_{\mathrm{1}}\mathrel{=}\Varid{t}_{\mathrm{2}}}                 & \text{Unification} \\
&      & \vb & \ensuremath{\Varid{x}\mathrel{\coloneqq}\Varid{t}}                    & \text{Definition} \\
&      & \vb & \ensuremath{\Varid{x}\!\rightarrow\!\Varid{y}\mathrel{\coloneqq}\Varid{t}}            & \text{Definition} \\
&      & \vb & \ensuremath{\Varid{t}_{\mathrm{1}}\hspace{0.19em}\mathop{\rule[-0.1em]{0.15em}{0.75em}}\hspace{0.2em}\Varid{t}_{\mathrm{2}}}          & \text{Choice} \\
&      & \vb & \ensuremath{\textbf{if}\;(\Varid{t}_{\mathrm{1}})\;\textbf{then}\;\Varid{t}_{\mathrm{2}}\;\textbf{else}\;\Varid{t}_{\mathrm{3}}} & \text{Conditional expression} \\
&      & \vb & \ensuremath{\textbf{for}(\Varid{t}_{\mathrm{1}})\,\textbf{do}\,\Varid{t}_{\mathrm{2}}}             & \text{Finite loop} \\
&      & \vb & \ensuremath{\textbf{array}\{\Varid{t}_{\mathrm{1}},\mydots,\Varid{t}_{\Varid{n}}\}}   & \text{Array}, n \geq 0 \\
...
\rulename{dssquig1} &  \ensuremath{(\Varid{p}_{\mathrm{1}}\!\rightarrow\!\Varid{p}_{\mathrm{2}})\mathrel{\coloneqq}\Varid{t}} & \rightarrow
    & \ensuremath{\Varid{p}_{\mathrm{1}}\mathrel{\coloneqq}(\Varid{x}_{\mathrm{1}}\mathbin{:}\textbf{any});\,(\Varid{x}_{\mathrm{1}}\!\rightarrow\!\Varid{p}_{\mathrm{2}})\mathrel{\coloneqq}\Varid{t}} & \text{\ensuremath{\Varid{p}_{\mathrm{1}}} not a variable} \\
\rulename{dssquig2} &  \ensuremath{(\Varid{p}_{\mathrm{1}}\!\rightarrow\!\Varid{p}_{\mathrm{2}})\mathrel{\coloneqq}\Varid{t}} & \rightarrow
    & \ensuremath{\Varid{p}_{\mathrm{2}}\mathrel{\coloneqq}(\Varid{x}_{\mathrm{2}}\mathbin{:}\textbf{any});\,(\Varid{p}_{\mathrm{1}}\!\rightarrow\!\Varid{x}_{\mathrm{2}})\mathrel{\coloneqq}\Varid{t}} & \text{\ensuremath{\Varid{p}_{\mathrm{2}}} not a variable} \\
% \begin{array}[t]{@@{}l@@{}}
