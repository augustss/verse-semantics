...
\rulename{exi-swiz1} & \ensuremath{\Varid{l}\hspace{-0.14em}=\hspace{-0.14em}\exists\Varid{x}.\,\Varid{e}_{\mathrm{1}};\,\Varid{e}_{\mathrm{2}}} & \leftrightarrow & \ensuremath{\exists\Varid{x}.\,\Varid{l}\hspace{-0.14em}=\hspace{-0.14em}\Varid{e}_{\mathrm{1}};\,\Varid{e}_{\mathrm{2}}} & \ensuremath{\Varid{x}} \not\in \ensuremath{\mathsf{fvs}(\Varid{e}_{\mathrm{2}})}\\
\rulename{exi-swiz2} & \ensuremath{\Varid{l}\hspace{-0.14em}=\hspace{-0.14em}\Varid{e}_{\mathrm{1}};\,\exists\Varid{x}.\,\Varid{e}_{\mathrm{2}}} & \leftrightarrow & \ensuremath{\exists\Varid{x}.\,\Varid{l}\hspace{-0.14em}=\hspace{-0.14em}\Varid{e}_{\mathrm{1}};\,\Varid{e}_{\mathrm{2}}} & \ensuremath{\Varid{x}} \not\in \ensuremath{\mathsf{fvs}(\Varid{e}_{\mathrm{1}})}\\
...
%\rulename{subst-exi} & |S^[x==v]| & \movesto & |subst S x v ^[x==v]|
%  & \text{$|v|\ne|V^[x]|$} \\
...
\rulename{choice-fail-l} & \ensuremath{\textbf{fail}\;\rule[-0.1em]{0.15em}{0.75em}\;\Varid{e}} & \movesto & \ensuremath{\Varid{e}} & \text{Can be removed if all choices inside \ensuremath{\textbf{iter}}} \\
\rulename{choice-fail-r} & \ensuremath{\Varid{e}\;\rule[-0.1em]{0.15em}{0.75em}\;\textbf{fail}} & \movesto & \ensuremath{\Varid{e}} & \text{Can be removed if all choices inside \ensuremath{\textbf{iter}}} \\
\rulename{choice} & \ensuremath{\Conid{C} [\mskip1.5mu \Varid{e}_{\mathrm{1}}\;\rule[-0.1em]{0.15em}{0.75em}\;\Varid{e}_{\mathrm{2}}\mskip1.5mu]} & \movesto & \ensuremath{\Conid{C} [\mskip1.5mu \Varid{e}_{\mathrm{1}}\mskip1.5mu]\;\rule[-0.1em]{0.15em}{0.75em}\;\Conid{C} [\mskip1.5mu \Varid{e}_{\mathrm{2}}\mskip1.5mu]}
...
\rulegroupname{Iter}
\rulename{iter-fail}    & \ensuremath{\textbf{iter}(\textbf{fail})\{\Varid{e}_{\Varid{a}};\Varid{e}_{\Varid{f}};\Varid{e}_{\Varid{g}}\}} & \movesto & \ensuremath{\Varid{e}_{\Varid{g}} [\!\Varid{e}_{\Varid{a}}]} \\
\rulename{iter-value}   & \ensuremath{\textbf{iter}(\Varid{v})\{\Varid{e}_{\Varid{a}};\Varid{e}_{\Varid{f}};\Varid{e}_{\Varid{g}}\}} & \movesto & \ensuremath{\Varid{e}_{\Varid{f}} [\!\Varid{e}_{\Varid{a}}] [\!\Varid{v}] [\!\Varid{e}_{\Varid{g}}]} \\
\rulename{iter-choice}  & \ensuremath{\textbf{iter}(\Varid{e}_{\mathrm{1}}\hspace{0.19em}\mathop{\rule[-0.1em]{0.15em}{0.75em}}\hspace{0.2em}\Varid{e}_{\mathrm{2}})\{\Varid{e}_{\Varid{a}};\Varid{e}_{\Varid{f}};\Varid{e}_{\Varid{g}}\}} & \movesto &
   \multicolumn{2}{l}{\ensuremath{\textbf{iter}(\Varid{e}_{\mathrm{1}})\{\Varid{e}_{\Varid{a}};\Varid{e}_{\Varid{f}};\lambda\Varid{x} .\,\textbf{iter}(\Varid{e}_{\mathrm{2}})\{\Varid{x};\Varid{e}_{\Varid{f}};\Varid{e}_{\Varid{g}}\}\}}} \\
