...
\begin{figure}
  ...
  \equa{\mathrm{lift}(f, w_1, w_2) = \mcompr{f(v_1, v_2)}{\mbind{v_1}{w_1}, \mbind{v_2}{w_2}}}
  ...
  \equa{\mathrm{apply}(f,x) = 
      \begin{cases*}
        ...
        f_x & if $f \in \tuple{Value}, x \in \mathbb{Z}, x \geqslant 0, x < \mathrm{size}(f)$ \\
        \mempty & otherwise, if $f \in \tuple{Value}$ \\
        \mathrm{WRONG} & otherwise
      \end{cases*}
  }
