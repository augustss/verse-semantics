...
pattern LitInt :: Integer -> SrcExpr
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Initially we parse SrcExpr into a bunch of Macro1/2 and InfixOp.
Notable examples:
...
data PrimOp
 ...
 | Gt | Lt | NEq | GEq | LEq
   ...
   -- Type tests
 | IsInt | IsStr | IsChar | IsArr | IsTru | IsGround | IsFun | IsComp
