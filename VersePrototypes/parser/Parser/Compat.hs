...
expToSrcExpr' l (R.Type e)        = Src.Macro1 (macro l "type") [] (lexp e)
...
-- expToSrcExpr' Domain           = ???
expToSrcExpr' l (R.Inst (L _ (R.Name "ci")) e) = Src.Macro1 (macro l "choice_index") [] (lexp e)
expToSrcExpr' l (R.Inst (L _ (R.Name "choice_index")) e) = Src.Macro1 (macro l "choice_index") [] (lexp e)
expToSrcExpr' l (R.Inst (L _ (R.Name "rtype")) e) = Src.Macro1 (macro l "rtype") [] (lexp e)
expToSrcExpr' l (R.Inst (L _ (R.ParenInvoke (L _ (R.Name "relation")) e1)) e2) = Src.Relation (lexp e1) Src.effSucceeds (lexp e2)
expToSrcExpr' l (R.Inst (L _ (R.ParenInvoke (L _ (R.Name "rel")) e1)) e2) = Src.Relation (lexp e1) Src.effSucceeds (lexp e2)
...
expToSrcExpr' _ (R.Str (L _ txt))    = Src.Lit (Src.LStr $ T.unpack txt)
